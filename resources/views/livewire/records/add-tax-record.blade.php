		...
		<form wire:submit.prevent='addRecord'>
			<div class="form-control">
				...
				<div class="flex flex-col space-y-2 space-x-0 sm:flex-row sm:space-y-0 sm:space-x-2">
					<div>
						<input type="text" id="name" class="w-full input input-bordered" wire:model='name' placeholder="Name"
							required>
					</div>
					<div>
						<input type="number" min="0" id="name" class="w-full input input-bordered" wire:model='value'
