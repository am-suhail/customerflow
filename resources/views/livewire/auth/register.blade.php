			...
			<div class="md:flex w-full">
				...
				<div class="w-full md:w-1/2 py-10 px-5 md:px-10">
					...
					<form wire:submit.prevent="register">
						...
						<div class="mt-6">
							<label for="mobile" class="block text-sm font-medium leading-5 text-gray-700">
								Mobile
							</label>

							<div class="mt-1 rounded-md shadow-sm">
								<input wire:model.lazy="mobile" id="mobile" type="mobile" required placeholder="+971*********"
						...
						<div class="mt-6">
							...
							<div class="flex justify-center w-full" wire:loading>
								<span>
									<x-icons.cog class="w-8 h-8 text-indigo-600 animate-spin" />
								</span>
							</div>
						</div>

						<div class="mt-4">
							<a href="{{ route('login') }}" class="text-blue-600 hover:text-gray-600">
