<div class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll bg-gray-50">
    <!-- Main content header -->
    <x-headers.button-page-heading :title="'Edit Project'" :route="'project.index'" />
        ...
        <div class="w-full p-5 bg-white rounded-lg shadow-xl md:w-10/12 lg:w-3/4">
            ...
            <form wire:submit.prevent="process">
                <div class="form-control">
                    ...
                    <input type="text" wire:model.lazy="name" id="name" class="input input-primary input-bordered 
                    @error('name')
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="col-start-1 col-end-2 form-control">
                        ...
                        <input wire:model.lazy="inward" type="date" id="inward" class="input input-bordered input-primary
                        @error('inward')
                        border-2 border-red-600
                        @enderror">
                        @error('inward')
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        ...
                        <x-select-search :data="$vendors" wire:model.lazy="vendor_id"
                    ...
                    <div class="form-control">
                        <label for="referral_no" class="font-semibold uppercase label">Project Referral
                            Number</label>
                        <input
                            class="input input-bordered input-primary @error('referral_no') border-2 border-red-600 @enderror"
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="col-start-1 col-end-2 form-control">
                        <label for="building_name" class="font-semibold uppercase label">Building Name</label>
                        <input
                            class="input input-bordered input-primary @error('building_name') border-2 border-red-600 @enderror"
                            wire:model.lazy="building_name" type="text" id="building_name">
                        @error('building_name')
                        <label class="label">
                            <span class="text-red-600 label-text-alt">{{ $message }}</span>
                        </label>
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        ...
                        <input
                            class="input input-bordered input-primary @error('area') border-2 border-red-600 @enderror"
                            wire:model.lazy="area" type="text" id="area">
                        @error('area')
                        <label class="label">
                            <span class="text-red-600 label-text-alt">{{ $message }}</span>
                        </label>
                    ...
                    <div class="form-control">
                        ...
                        <input
                            class="input input-bordered input-primary @error('street') border-2 border-red-600 @enderror"
                            wire:model.lazy="street" type="text" id="street">
                        @error('street')
                        <label class="label">
                            <span class="text-red-600 label-text-alt">{{ $message }}</span>
                        </label>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="grid grid-cols-6 gap-4 p-2 my-1 bg-base-200 rounded-md">
                            <div class="col-span-6">
                                <livewire:project.product-input :service="$value" :wire:key="'service-key-'.$index"
                                    :key_id="$index" />
                            </div>
                            <div class="col-span-6">
                                <button type="button"
                                    class="float-right bg-red-600 border-0 hover:bg-red-500 btn btn-xs"
                ...
                <div class="grid grid-cols-2 mt-4">
                    <div class="fomr-control">
                        ...
                        <textarea class="textarea textarea-bordered textarea-primary @error(' remarks') border-2
                            border-red-600 @enderror" wire:model.lazy="remarks" cols="50" rows="10" id="remarks">
                            </textarea>
                        @error('remarks')
                        <label class="label">
                            <span class="text-red-600 label-text-alt">{{ $message }}</span>
