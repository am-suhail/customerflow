        ...
        <div class="flex items-center justify-between mb-1">
            ...
            <div class="flex flex-wrap items-center space-x-1">
                ...
                <button wire:click="clearAllFilters"
                    class="flex items-center px-3 space-x-2 text-xs font-medium leading-4 tracking-wider text-red-500 uppercase bg-white border border-red-400 rounded-md hover:bg-red-200 focus:outline-none"><span>{{ __('Reset') }}</span>
                        ...
                        <div
                            ...
                            <div>
                                <input type="checkbox" wire:click="toggleSelectAll"
                                    @if(count($selected)===$this->results->total()) checked @endif class="w-4 h-4 mt-1 text-blue-600 transition duration-150 ease-in-out form-checkbox" />
                            </div>
                        </div>
            ...
            <div class="items-center justify-between p-2 sm:flex">
                ...
                <div class="flex items-center my-2 sm:my-0">
                    <select name="perPage"
                        ...
                        wire:model="perPage">
                        @foreach(config('livewire-datatables.per_page_options', [ 10, 25, 50, 100 ]) as
                        $per_page_option)
