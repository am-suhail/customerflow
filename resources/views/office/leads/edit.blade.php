...
<main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll bg-gray-50">
    ...
    <div class="flex items-start justify-center w-full pt-4">
        <div class="w-full p-5 bg-white rounded-lg shadow-xl md:w-10/12 lg:w-3/4">
            <form action="{{ route('leads.update', $lead)  }}" method="POST" id="add_vehicle_form">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        ...
                        {!! Form::text('name', old('name', $lead->name), ['class' => 'input input-primary
                        input-bordered'
                    ...
                    <div class="form-control">
                        ...
                        uppercase'])
                        !!}
                        {!! Form::text('designation', old('designation', $lead->designation), ['class' => 'input
                        input-bordered
                        input-primary'
                ...
                <div class='grid grid-flow-row grid-cols-2 gap-4 mt-4'>
                    <div class="col-start-1 col-end-2 form-control">
                        ...
                        {!! Form::select('country_id', $countries, old('country_id', $lead->country_id), [
                        'placeholder' => '--choose--',
                ...
                <div class='grid grid-flow-row grid-cols-2 gap-4 mt-4'>
                    <div class="form-control">
                        ...
                        !!}
                        {!! Form::text('company_name', old('company_name', $lead->company_name), ['class' => 'input
                        input-bordered
                        input-primary'
                    ...
                    <div class="form-control">
                        ...
                        !!}
                        {!! Form::select('industry_id', $industries, old('industry_id', $lead->industry_id), [
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        ...
                        !!}
                        {!! Form::email('email', old('email', $lead->email), ['class' => 'input input-bordered
                        input-primary'
                    ...
                    <div class="form-control">
                        ...
                        !!}
                        {!! Form::number('mobile', old('mobile', $lead->mobile), ['class' => 'input input-bordered
                        input-primary'
                ...
                <div class='grid grid-flow-row grid-cols-2 gap-4 mt-4'>
                    <div class="form-control">
                        ...
                        !!}
                        {!! Form::number('landline', old('landline', $lead->landline), ['class' => 'input input-bordered
                        input-primary'
                    ...
                    <div class="form-control">
                        ...
                        uppercase'])
                        !!}
                        {!! Form::number('alternate_number', old('alternate_number', $lead->alternate_number), ['class'
                ...
                <div class="mt-4">
                    <livewire:state-city :selectedCity="old('city_id', $lead->city_id)">
                </div>

                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        {!! Form::label('area', 'Area', ['class' => 'label font-semibold uppercase']) !!}
                        {!! Form::text('area', old('area', $lead->area), ['class' => 'input input-primary
                        input-bordered'
                    ...
                    <div class="form-control">
                        ...
                        uppercase'])
                        !!}
                        {!! Form::text('street', old('street', $lead->street), ['class' => 'input input-bordered
                        input-primary'
                ...
                <div class='grid grid-flow-row grid-cols-2 gap-4 mt-4'>
                    <div class="col-start-1 col-end-2 form-control">
                        ...
                        uppercase'])
                        !!}
                        {!! Form::textarea('address', old('address', $lead->address), [
                        'class' => 'input input-bordered input-primary'
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        ...
                        uppercase'])
                        !!}
                        {!! Form::text('executive', old('executive', $lead->user->name), ['class' => 'input
                        input-bordered
                        input-primary'
                        . ($errors->has('executive') ? 'border-2 border-red-600' : '') ]) !!}
                        @error('executive')
                        <label class="label">
                            <span class="text-red-600 label-text-alt">{{ $message }}</span>
                        </label>
                    ...
                    <div class="form-control">
                        ...
                        uppercase']) !!}
                        {!! Form::date('date', old('date', $lead->date), [
                        'required' => 'required',
                        'class' => 'input input-bordered input-primary'
                ...
                <div class="mt-4">
                    <livewire:category-sub-category
                        :selectedSubCategory="old('sub_category_id', $lead->sub_category_id)">
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="form-control">
                        <label class="bg-blue-300 rounded cursor-pointer label">
                            ...
                            <input type="checkbox" name="demo_presented" class="checkbox" {{ $lead->demo_presented
                            ? 'checked' : '' }}>
                        </label>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="col-start-1 col-end-2 form-control">
                        ...
                        uppercase'])
                        !!}
                        {!! Form::textarea('feedback', old('feedback', $lead->feedback), [
                        'class' => 'input input-bordered input-primary'
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div class="col-start-1 col-end-2 form-control">
                        ...
                        uppercase'])
                        !!}
                        {!! Form::textarea('remarks', old('remarks', $lead->remarks), [
                        'class' => 'input input-bordered input-primary'
                ...
                <div class='grid grid-flow-row grid-cols-2 gap-4 mt-4'>
                    <div>
                        ...
                        <input type="submit" class='btn btn-accent' value="Update">
                    </div>
                </div>
            </form>
        </div>
