        ...
        <table class="w-full">
            <tbody>
                ...
                <tr class="">
                    ...
                    <td class="text-gray-400">
                        Manage units of measurement for services (UOM)
                    </td>
                    <td class="float-right">
                        <div class="py-2">
                            <a href="{{ route('master.unit') }}" class="text-blue-600 hover:text-blue-400">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
                ...
                <tr class="">
                    ...
                    <td class="text-gray-400">
                        Manage project status tags
                    </td>
                    <td class="float-right">
                        <div class="py-2">
                            <a href="{{ route('master.badge') }}" class="text-blue-600 hover:text-blue-400">
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1" viewBox="0 0 20 20"
                                        fill="currentColor">
                                        <path fill-rule="evenodd"
