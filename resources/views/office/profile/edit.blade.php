        ...
        <div class="w-full p-5 bg-white rounded-lg shadow-xl md:w-10/12 lg:w-3/4">
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="col-start-1 col-end-2 form-control">
                    ...
                    {!! Form::text('name', old('name', Auth::user()->name), ['class' => 'input input-primary
                    input-bordered'
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    ...
                    {!! Form::text('mobile', old('mobile', Auth::user()->mobile), ['class' => 'input input-primary
                    input-bordered'
                ...
                <div class="form-control">
                    ...
                    {!! Form::email('email', old('email', Auth::user()->email), ['class' => 'input input-primary
                    input-bordered'
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    ...
                    {!! Form::text('nid', old('nid', Auth::user()->user_detail->nid), ['class' => 'input
                    input-primary input-bordered'
                    . ($errors->has('nid') ? 'border-2 border-red-600' : '')]) !!}
                    @error('nid')
                    <label class="label">
                        <span class="text-red-600 label-text-alt">{{ $message }}</span>
                    </label>
                ...
                <div class="form-control">
                    ...
                    !!}
                    {!! Form::date('nid_expiry', old('nid_expiry', Auth::user()->user_detail->nid_expiry), ['class'
                    => 'input input-bordered input-primary'
                    . ($errors->has('nid_expiry') ? 'border-2 border-red-600' : '')]) !!}
                    @error('nid_expiry')
                    <label class="label">
                        <span class="text-red-600 label-text-alt">{{ $message }}</span>
                    </label>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    ...
                    Auth::user()->user_detail->sex), ['placeholder' => '--choose--', 'class' => 'select
                    select-bordered select-primary'
                    . ($errors->has('sex') ? 'border-2 border-red-600' : '') ]) !!}
                    @error('sex')
                    <label class="label">
                        <span class="text-red-600 label-text-alt">{{ $message }}</span>
                    </label>
                ...
                <div class="form-control">
                    ...
                    {!! Form::date('dob', old('dob', Auth::user()->user_detail->dob), ['class' => 'input
                    input-bordered input-primary'
                    . ($errors->has('dob') ? 'border-2 border-red-600' : '') ]) !!}
                    @error('dob')
                    <label class="label">
                        <span class="text-red-600 label-text-alt">{{ $message }}</span>
                    </label>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="col-start-1 col-end-2 form-control">
                    ...
                    ['placeholder' => '--choose--', 'class' => 'select select-bordered select-primary'
            ...
            <div>
                <livewire:state-city
                    :selectedCity="$errors ? old('city_id', Auth::user()->user_detail->city_id) : NULL">
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    ...
                    uppercase']) !!}
                    {!! Form::text('area', old('area', Auth::user()->user_detail->area), ['class' => 'input
                    input-bordered input-primary'
                ...
                <div class="form-control">
                    ...
                    uppercase']) !!}
                    {!! Form::text('street', old('street', Auth::user()->user_detail->street), ['class' => 'input
                    input-bordered input-primary'
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    {!! Form::label('qualification_id', 'Qualification', ['placeholder' => '--choose--', 'class' =>
                    'label font-semibold uppercase']) !!}
                    {!! Form::select('qualification_id', $qualifications, old('qualification_id',
                    Auth::user()->user_detail->qualification_id), ['class' =>
                ...
                <div class="form-control">
                    {!! Form::label('years_of_exp', 'Years of Experience', ['class' => 'label font-semibold
                    uppercase']) !!}
                    {!! Form::number('years_of_exp', old('years_of_exp', Auth::user()->user_detail->years_of_exp),
                    ['class' => 'input input-bordered input-primary'
                    . ($errors->has('years_of_exp') ? 'border-2 border-red-600' : '')]) !!}
                    @error('years_of_exp')
                    <label class="label">
                        <span class="text-red-600 label-text-alt">{{ $message }}</span>
                    </label>
