...
<main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
    <!-- Main content header -->
    <x-page-heading :title="$pageTitle" />
                ...
                <div class="m-auto">
                    <div class="flex flex-col px-10 py-8 bg-gray-100 rounded-md shadow-md md:px-8">
                        <div class="flex flex-col items-center justify-center gap-6 md:flex-row md:gap-8">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-500 w-28 h-28" fill="none"
                            ...
                            <div class="flex flex-col text-center md:text-left">
                                ...
                                <div class="flex flex-row gap-4 mx-auto my-auto text-2xl text-gray-800 md:mx-0">
                                    <a class="hover:cursor-pointer hover:text-blue-500"><i
                    ...
                    <div class="flex flex-col px-10 bg-gray-100 rounded-md shadow-md md:px-8">
                        <div class="flex items-center mb-8 md:flex-row md:gap-8">
                            <div class="flex flex-col">
                                ...
                                <span class="text-lg font-medium text-gray-800">
                                    {{ Auth::user()->user_detail->nid ?? '--' }}
                                </span>
                            </div>
                            <div class="flex flex-col">
                                <span>National ID Expiry</span>
                                <span class="text-lg font-medium text-gray-800">
                                    {{ Auth::user()->user_detail->nid_expiry->format('d/m/Y') }}
                                </span>
                            </div>
                            <div class="flex flex-col">
                                <span>Sex</span>
                        ...
                        <div class="flex items-center mb-8 md:flex-row md:gap-8">
                            ...
                            <div class="flex flex-col">
                                <span class="text-lg font-medium text-gray-600">
                                    {{ Auth::user()->user_detail->area ?? '--' }}
                                </span>
                            </div>
                            <div class="flex flex-col">
                                <span class="text-lg font-medium text-gray-600">
                                    {{ Auth::user()->user_detail->street ?? '--' }}
                                </span>
                            </div>
                        </div>
