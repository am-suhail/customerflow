...
<main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll bg-gray-50">
    ...
    <div class="flex items-start justify-center w-full pt-4">
        <div class="w-full p-5 bg-white rounded-lg shadow-xl md:w-10/12 lg:w-3/4">
            {!! Form::open([
            'route' => ['enquiry.update', $enquiry],
            'method' => 'PUT'
            ]) !!}

            <div class="form-control">
                {!! Form::label('name', 'Project Enquiry Name', ['class' => 'label font-semibold uppercase']) !!}
                {!! Form::text('name', old('name', $enquiry->name), ['class' => 'input input-primary input-bordered'
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    ...
                    {!! Form::date('date', old('date', $enquiry->date), ['class' => 'input input-bordered
                    input-primary'
            ...
            <div class="my-8 divider">Job Details</div>

            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    {!! Form::label('category_id', 'Job Type', ['class' => 'label font-semibold
                    uppercase']) !!}
                    {!! Form::select('category_id', $categories, old('category_id', $enquiry->category_id), [
                    'placeholder' => '--choose job type--',
                    'class' => 'select select-bordered select-primary'
                    . ($errors->has('category_id') ? 'border-2 border-red-600' : '')]) !!}
                    @error('category_id')
                    <label class="label">
                        <span class="text-red-600 label-text-alt">{{ $message }}</span>
                    </label>
                ...
                <div class="form-control">
                    {!! Form::label('vendor_id', 'Select Customer', ['class' => 'label font-semibold
                    uppercase']) !!}
                    {!! Form::select('vendor_id', $vendors, old('vendor_id', $enquiry->vendor_id), [
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="col-start-1 col-end-2 form-control">
                    {!! Form::label('assigned_user_id', 'Assign to Team Leader', ['class' => 'label font-semibold
                    uppercase']) !!}
                    {!! Form::select('assigned_user_id', $employees, old('assigned_user_id',
                    $enquiry->assigned_user_id), [
                    'placeholder' => '--choose--',
                    'class' => 'select select-bordered select-primary'
                    . ($errors->has('assigned_user_id') ? 'border-2 border-red-600' : '')]) !!}
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="col-start-1 col-end-2 form-control">
                    ...
                    uppercase'])
                    !!}
                    {!! Form::text('building_name', old('building_name', $enquiry->building_name), ['class' => 'input
            ...
            <div>
                <livewire:state-city :selectedCity="$errors ? old('city_id', $enquiry->city_id) : NULL">
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="form-control">
                    ...
                    uppercase']) !!}
                    {!! Form::text('area', old('area', $enquiry->area), ['class' => 'input
                    input-bordered input-primary'
                ...
                <div class="form-control">
                    ...
                    uppercase']) !!}
                    {!! Form::text('street', old('street', $enquiry->street), ['class' => 'input
                    input-bordered input-primary'
            ...
            <div class="grid grid-cols-2 mt-4">
                <div class="fomr-control">
                    ...
                    {!! Form::textarea('requirement', old('requirement', $enquiry->requirement), ['class' => 'textarea
