<header class="flex-shrink-0 border-b shadow-sm">
    <div class="flex items-center justify-between py-2 pr-4">
        ...
        <div class="flex items-center space-x-3">
            <span class="p-2 text-xl font-semibold tracking-wider uppercase lg:hidden">D.I.T</span>
            <!-- Toggle sidebar button -->
            <button @click="toggleSidbarMenu()" class="h-full p-4 transform -translate-x-4 bg-gray-800 rounded-md">
                    ...
                    <div class="flex justify-center py-2 text-blue-500 border-t ">
                        ...
                        <a href="{{ route('logout') }}"
                            ...
                            <button class="btn btn-sm btn-info">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
